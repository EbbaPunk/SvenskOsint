...
API_KEY = "AIzaSyCNdg9tdpC312Th4Es-3hDqyrngIYnrpwc"
...
HEADERS = {
    ...
    "Origin": "https://minasidor.pressbyran.se",
    "x-client-version": "Chrome/JsCore/10.8.1/FirebaseCore-web",
    "x-firebase-gmpid": "1:492322508526:web:4015b07ccad7119347edff",
...
def pressbyran(email: str) -> Dict[str, Any]:
...
if __name__ == "__main__":
    ...
    print(json.dumps(pressbyran(email), ensure_ascii=False, indent=2))
