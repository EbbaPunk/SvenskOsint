...
HEADERS = {
    ...
    "Origin": "https://registrera.expressen.se",
    "Referer": "https://registrera.expressen.se/",
...
def expressen(email: str) -> Dict[str, Any]:
    result: Dict[str, Any] = {
        "accountExists": False,
        "userId": None,
        "firstName": None,
    ...
    try:
        r = requests.post(
            LOOKUP_URL,
            json={"email": email, "namespace": "expressen"},
            headers=HEADERS,
            timeout=10,
        )
        data = r.json()
...
if __name__ == "__main__":
    ...
    print(json.dumps(expressen(email), indent=2))
