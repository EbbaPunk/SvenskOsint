...
HEADERS = {
    ...
    "Origin": "https://registrera.dn.se",
    "Referer": "https://registrera.dn.se/",
...
if __name__ == "__main__":
    ...
    print(json.dumps(dn(email), indent=2))
